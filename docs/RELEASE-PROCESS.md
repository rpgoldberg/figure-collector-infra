...
- Version tracking files (version.json, application-versions.json) must match actual package.json versions
...
- application-versions.json updated to v2.1.0
...
8. **After testing succeeds**, update `"released": "date"` in application-versions.json
